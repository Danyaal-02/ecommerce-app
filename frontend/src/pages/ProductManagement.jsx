    ...
    >
            ...
            <div className="bg-gray-800 shadow-lg rounded-lg overflow-hidden">
              <div className="p-4 sm:p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button type="submit" className="w-full bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-md hover:from-indigo-600 hover:to-purple-700 transition duration-300 flex items-center justify-center">
      ...
      >
        <form onSubmit={handleUpdateSubmit} className="space-y-4">
          ...
          <button type="submit" className="w-full bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-6 py-3 rounded-md hover:from-indigo-600 hover:to-purple-700 transition duration-300">
            Update Product
          </button>
        </form>
      </ProductModal>
